...
## Current state
- Phase 1 ✅ done (scaffold + PWA). Next: **Phase 2** — Supabase schema + migrations + RLS + seed sentiment.
- Phase 2 needs a Supabase project (URL + publishable key) before it can run end-to-end.
