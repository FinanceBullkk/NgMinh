  ...
  return (
    <section className="flex flex-col gap-3 p-4">
      <div className="flex items-center justify-between">
        <h2 className="text-sm font-semibold text-zinc-800">Dòng thời gian</h2>
        <span className="text-xs text-zinc-400">{visible.length} ghi nhận</span>
      </div>
      ...
      <ul className="flex flex-col">
        ...
        {visible.length === 0 && (
          <li className="py-6 text-center text-xs text-zinc-400">Chưa có ghi chép.</li>
        )}
      </ul>
    </section>
  );
